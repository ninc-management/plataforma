...
describe('NortanService', () => {
  ...
  const baseTest = (
    name: string,
    test: (expectedExpenses: Expense[]) => void
  ) => {
    it(name, (done: DoneFn) => {
      let i = 1;
  ...
  baseTest('getExpenses should work', (expectedExpenses: Expense[]) =>{});

  baseTest('expensesSize should work', (expectedExpenses: Expense[]) => {
