  ...
  generatePDF(event): void {
    ...
    let docDefinition = {
      ...
      content: [
        ...
        {
          text: 'Oi ' + event.data.contractorName + ', tudo bem?',
          alignment: 'center',
        },
        {
          text:
            ...
            event.data.fullName +
            ', será sua Consultor@ Técnica Exclusiv@ e gestor@ do contrato, te guiando para solução mais eficiente.',
          alignment: 'center',
        },
        {
          columns: [
            [
              {
                qr:
                  "http://plataforma.nortanprojetos.com/invoices/?code='" +
                  event.data.code +
                  "'",
                fit: '50',
              },
